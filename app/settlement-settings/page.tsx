...
export default function SettlementSettingsPage() {
  ...
  return (
    <>
      <PageHeader
        title="정산설정"
        description="담당자 × 결제수단별 정산요율(%)을 관리자가 미리 설정해두면, 계약에 설정된 결제방식과 연결되어 정산 메뉴의 예상 정산액에 자동으로 반영됩니다."
      />
      ...
      <Card className="mb-4 space-y-2 border-blue-100 bg-blue-50/60 p-4 text-xs text-blue-700">
        ...
        <div>
          1. 이 화면에서 담당자별 · 결제수단별 정산요율(%)을 설정합니다. &nbsp;→&nbsp; 2. 계약 레코드에 저장된 결제방식과
          담당자를 기준으로 요율을 찾습니다. &nbsp;→&nbsp; 3. 정산 메뉴의 담당자별 정산 요약에 (담당자 × 결제방식) 요율이
          곱해진 예상 정산액이 자동으로 계산되어 표시됩니다.
        </div>
      </Card>
